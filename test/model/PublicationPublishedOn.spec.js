...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.PublicationPublishedOn();
  });
  ...
  describe('PublicationPublishedOn', function() {
    it('should create an instance of PublicationPublishedOn', function() {
      // uncomment below and update the code to test PublicationPublishedOn
      //var instance = new ProxycurlApi.PublicationPublishedOn();
      //expect(instance).to.be.a(ProxycurlApi.PublicationPublishedOn);
    });
