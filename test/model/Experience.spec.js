...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.Experience();
  });
  ...
  describe('Experience', function() {
    it('should create an instance of Experience', function() {
      // uncomment below and update the code to test Experience
      //var instance = new ProxycurlApi.Experience();
      //expect(instance).to.be.a(ProxycurlApi.Experience);
    });
