...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.EmployeeList();
  });
  ...
  describe('EmployeeList', function() {
    it('should create an instance of EmployeeList', function() {
      // uncomment below and update the code to test EmployeeList
      //var instance = new ProxycurlApi.EmployeeList();
      //expect(instance).to.be.a(ProxycurlApi.EmployeeList);
    });
