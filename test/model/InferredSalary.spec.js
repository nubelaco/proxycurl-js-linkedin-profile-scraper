...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.InferredSalary();
  });
  ...
  describe('InferredSalary', function() {
    it('should create an instance of InferredSalary', function() {
      // uncomment below and update the code to test InferredSalary
      //var instance = new ProxycurlApi.InferredSalary();
      //expect(instance).to.be.a(ProxycurlApi.InferredSalary);
    });
