...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.CompanyRevealRoleProfile();
  });
  ...
  describe('CompanyRevealRoleProfile', function() {
    it('should create an instance of CompanyRevealRoleProfile', function() {
      // uncomment below and update the code to test CompanyRevealRoleProfile
      //var instance = new ProxycurlApi.CompanyRevealRoleProfile();
      //expect(instance).to.be.a(ProxycurlApi.CompanyRevealRoleProfile);
    });
