...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.AcquiredCompanyAnnouncedDate();
  });
  ...
  describe('AcquiredCompanyAnnouncedDate', function() {
    it('should create an instance of AcquiredCompanyAnnouncedDate', function() {
      // uncomment below and update the code to test AcquiredCompanyAnnouncedDate
      //var instance = new ProxycurlApi.AcquiredCompanyAnnouncedDate();
      //expect(instance).to.be.a(ProxycurlApi.AcquiredCompanyAnnouncedDate);
    });
