...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.CompanyUpdatePostedOn();
  });
  ...
  describe('CompanyUpdatePostedOn', function() {
    it('should create an instance of CompanyUpdatePostedOn', function() {
      // uncomment below and update the code to test CompanyUpdatePostedOn
      //var instance = new ProxycurlApi.CompanyUpdatePostedOn();
      //expect(instance).to.be.a(ProxycurlApi.CompanyUpdatePostedOn);
    });
