...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.Activity();
  });
  ...
  describe('Activity', function() {
    it('should create an instance of Activity', function() {
      ...
      //var instance = new ProxycurlApi.Activity();
      //expect(instance).to.be.a(ProxycurlApi.Activity);
    });
    ...
    it('should have the property activityStatus (base name: "activity_status")', function() {
