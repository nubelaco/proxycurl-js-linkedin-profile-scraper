...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.PatentIssuedOn();
  });
  ...
  describe('PatentIssuedOn', function() {
    it('should create an instance of PatentIssuedOn', function() {
      // uncomment below and update the code to test PatentIssuedOn
      //var instance = new ProxycurlApi.PatentIssuedOn();
      //expect(instance).to.be.a(ProxycurlApi.PatentIssuedOn);
    });
