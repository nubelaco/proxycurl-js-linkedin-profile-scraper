...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.HonourAwardIssuedOn();
  });
  ...
  describe('HonourAwardIssuedOn', function() {
    it('should create an instance of HonourAwardIssuedOn', function() {
      // uncomment below and update the code to test HonourAwardIssuedOn
      //var instance = new ProxycurlApi.HonourAwardIssuedOn();
      //expect(instance).to.be.a(ProxycurlApi.HonourAwardIssuedOn);
    });
