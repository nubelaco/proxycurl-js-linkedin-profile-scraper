...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.CompanyDetailsIpoDate();
  });
  ...
  describe('CompanyDetailsIpoDate', function() {
    it('should create an instance of CompanyDetailsIpoDate', function() {
      // uncomment below and update the code to test CompanyDetailsIpoDate
      //var instance = new ProxycurlApi.CompanyDetailsIpoDate();
      //expect(instance).to.be.a(ProxycurlApi.CompanyDetailsIpoDate);
    });
