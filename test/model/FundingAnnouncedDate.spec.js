...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.FundingAnnouncedDate();
  });
  ...
  describe('FundingAnnouncedDate', function() {
    it('should create an instance of FundingAnnouncedDate', function() {
      // uncomment below and update the code to test FundingAnnouncedDate
      //var instance = new ProxycurlApi.FundingAnnouncedDate();
      //expect(instance).to.be.a(ProxycurlApi.FundingAnnouncedDate);
    });
