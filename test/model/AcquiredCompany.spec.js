...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.AcquiredCompany();
  });
  ...
  describe('AcquiredCompany', function() {
    it('should create an instance of AcquiredCompany', function() {
      // uncomment below and update the code to test AcquiredCompany
      //var instance = new ProxycurlApi.AcquiredCompany();
      //expect(instance).to.be.a(ProxycurlApi.AcquiredCompany);
    });
