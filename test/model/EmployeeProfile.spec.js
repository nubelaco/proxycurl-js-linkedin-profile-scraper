...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new ProxycurlApi.EmployeeProfile();
  });
  ...
  describe('EmployeeProfile', function() {
    it('should create an instance of EmployeeProfile', function() {
      // uncomment below and update the code to test EmployeeProfile
      //var instance = new ProxycurlApi.EmployeeProfile();
      //expect(instance).to.be.a(ProxycurlApi.EmployeeProfile);
    });
